...
class CharactersListViewModel @Inject constructor(val repository: GetCharactersRepositoryImpl) :
    BaseViewModel() {

    lateinit var disposableObserverCharacters: DisposableObserver<MarvelCharactersResponse>
